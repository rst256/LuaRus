...
function MyFrame:CreateTextCtrl(ctrl_text)
    ...
    if (ctrl_text and ctrl_text ~= "") then
		...
		local textCtrl = wx.wxTextCtrl(this,wx.wxID_ANY, text,
        wx.wxPoint(0,0), wx.wxSize(150,90),
        wx.wxNO_BORDER + wx.wxTE_MULTILINE + wx.wxTE_RICH + wx.wxTE_RICH2);
		textCtrl:SetStyle(1,5, wx.wxTextAttr(wx.wxRED,wx.wxBLACK, wx.wxNullFont,
