...
local is_string_mt = {
	__index={
		___type='is_string',
		___validate=function(self, value)
			...
			if self.pattern and not value:match(self.pattern) then
				return false, error_message(value,
					'a string, pattern '..self.pattern)
			end
			return true
		end,
	},
	__call=function(self, value)
    return self.___validate(self, value)
  end,
	__tostring=function(self)
		return 'validator:'..self.___type..'()'
	end,
}

function M.is_string(ops)
	return setmetatable(ops or {}, is_string_mt)
end
