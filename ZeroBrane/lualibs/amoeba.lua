...
function Variable:__unm(other) return Expression.new(self, -1.0) end
function Expression:__unm() self:multiply(-1.0) end
...
function Variable:__pow(pow) return Expression.new(self)*Expression.new(self) end
--function Variable:__unm() return -1*Expression.new(self) end
...
--function Expression:__unm() return -1*Expression.new(self) end
