...
--UI.MyDialog1 = wx.wxPanel(parent or wx.NULL, wx.wxID_ANY)
	...
	UI.m_PkgLists = wx.wxNotebook( UI.MyDialog1, wx.wxID_ANY, wx.wxDefaultPosition, wx.wxDefaultSize, 0 )
...
--	UI.bSizer2:Add(UI.m_checkList1, 1, wx.wxALL+wx.wxEXPAND, 5)
	...
	UI.m_checkList1 = wx.wxListBox( UI.m_PkgLists, wx.wxID_ANY, wx.wxDefaultPosition, wx.wxDefaultSize, {}, wx.wxLB_SORT )
	UI.m_PkgLists:AddPage(UI.m_checkList1, "By names", false)

	UI.bSizer2:Add(UI.m_PkgLists, 1, wx.wxALL+wx.wxEXPAND, 5)
...
--      ide:AddPanelDocked(ide.frame.projnotebook, main_frame.MyDialog1, 'PluginsPanel', TR("Plugins"), function(pane)  end)
